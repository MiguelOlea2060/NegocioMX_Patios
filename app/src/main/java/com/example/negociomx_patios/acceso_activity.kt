...
import com.example.negociomx_patios.Utils.negociomx_posApplication.Companion.prefs
import com.example.negociomx_patios.databinding.ActivityAccesoBinding
                ...
                if (nombreUsuarioEmail.isEmpty() == true) {
                    ...
                    loguearUsuario(nombreUsuarioEmail, pwd) { usuarioLogueado ->
                        ...
                        if (usuarioLogueado == true) {
                            ...
                            mainHandler.post {
                                val intent = Intent(applicationContext, Paso1Vin_Activity::class.java)
